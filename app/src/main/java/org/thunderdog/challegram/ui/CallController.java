...
public class CallController extends ViewController<CallController.Arguments> implements TdlibCache.UserDataChangeListener, TdlibCache.CallStateChangeListener, View.OnClickListener, FactorAnimator.Target, Runnable, CallControlsLayout.CallControlCallback {
  ...
  private ButtonView muteButtonView, speakerButtonView, soundSettingsButtonView;
  ...
  protected View onCreateView (final Context context) {
    ...
    muteButtonView.setLayoutParams(new LinearLayout.LayoutParams(0, Screen.dp(72f), 1f));
    ...
    messageButtonView.setLayoutParams(new LinearLayout.LayoutParams(0, Screen.dp(72f), 1f));
    ...
    speakerButtonView.setLayoutParams(new LinearLayout.LayoutParams(0, Screen.dp(72f), 1f));

    soundSettingsButtonView = new ButtonView(context);
    soundSettingsButtonView.setId(R.id.btn_soundSettings);
    soundSettingsButtonView.setOnClickListener(this);
    soundSettingsButtonView.setIcon(R.drawable.baseline_equalizer_24);
    soundSettingsButtonView.setLayoutParams(new LinearLayout.LayoutParams(0, Screen.dp(72f), 1f));
    ...
    buttonWrap.addView(soundSettingsButtonView);
  ...
  public void onClick (View v) {
    ...
    } else if (viewId == R.id.btn_soundSettings) {
      CallSoundSettingsController.show(context());
